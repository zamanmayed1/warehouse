...
const Blog = () => {
    return (
        <div className='text-left py-6 mb-32 md:w-3/4 mx-auto p-2'>
            ...
            <div className="qna my-2 p-1 shadow-sm">
                <h1 className='text-xl font-bold text-indigo-600 my-2'>2 ) When should you use nodejs and when should you use mongodb ?</h1>
                <h2 className='ml-1'>
                    <span className="font-bold">Ans : </span> <br />
                    Nodejs- <br />
            ...
            <div className="qna my-2 p-1 shadow-sm">
                <h1 className='text-xl font-bold text-indigo-600 my-2'>3) Difference between javascript and nodejs ?</h1>
                <h2 className='ml-1'>
                    <span className="font-bold">Ans : </span> <br />
                    Javascript- <br />
